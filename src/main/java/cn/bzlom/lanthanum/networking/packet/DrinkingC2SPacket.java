...
public class DrinkingC2SPacket {
    public static final String MESSAGE_DRINKING_WATER = "message.lanthanum.drink_water";
    public static final String MESSAGE_NO_WATER_NEARBY = "message.lanthanum.no_water";
    ...
    public static void receive(MinecraftServer server, ServerPlayerEntity player, ServerPlayNetworkHandler handler,
        ...
        if (isAroudWaterThem(player, world, 2)) {
            ...
            player.sendMessage(Text.literal("Thirst:" + ((IEntityDataSaver) player).
                            getPersistentData().getInt("thirst")).
